  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <section className="relative w-full h-[600px] flex items-center justify-center bg-brand-blue text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-cover bg-center -z-10 bg-opacity-40"></div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <p className="text-lg md:text-2xl mb-10 text-gray-200">
            Maximize your investment potential with our premium Dual Key home
            designs. Perfect for investors and modern families.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center p-8 bg-white rounded-lg shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Generate two separate rental incomes from a single property
                title, significantly boosting your annual yield.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-lg shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Provide independent living spaces for elderly parents or young
                adults while keeping family close.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-lg shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Built with modern materials and energy-efficient designs to
                lower maintenance costs and attract quality tenants.
              </p>
            </div>
          </div>
        </div>
